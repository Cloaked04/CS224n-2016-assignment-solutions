...
class RNNCell(tf.nn.rnn_cell.RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            W_x = tf.get_variable(shape=(self.input_size,self.state_size), name='W_x', 
                                  initializer=tf.contrib.layers.xavier_initializer())
            W_h = tf.get_variable(shape=(self.state_size,self.state_size), name='W_h',
                                  initializer=tf.contrib.layers.xavier_initializer())
            b = tf.get_variable(shape=(self.state_size,), name='b',initializer=tf.zeros_initializer())
